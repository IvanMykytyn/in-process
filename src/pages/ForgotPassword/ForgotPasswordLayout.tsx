...
const ForgotPasswordLayout: FC<PropsWithChildren & CustomForgotPasswordProps> = ({children, header, description,}) => {
    return (
          ...
          <span className={css['forgot-password__icon']}>
            <span className={css['forgot-password__icon-inner']}>
              <img src={keyIcon} alt="logo"/>
                    ...
                    <h2 className={css['forgot-password__header']}>
                        {header}
                    </h2>
                    <p className={css['forgot-password__description']}>
                        {description}
                    </p>
                    <>
                        {children}
